...
if($_SESSION['menu_opciones'][1][1][1][0]['OpcionA'] == 1){
    ...
    $btnNuevo = '<button class="btn-primary btn-xs" onclick="fn_cat_nueva_area(1)" ><i class="fa fa-file"></i> Nuevo </button>';
...
<script>
    ...
    fn_catalogoAreas_lista(1);

</script>
<div class="panel panel-info">
    <div class="panel-heading"  style="padding: 3px;"><i class="fa fa-folder-open"></i> Catálogo de áreas</div>
    <div class="toolbars">
        ...
        <button id="btnHome" data-placement="top" data-toggle="tooltip" title="Actualizar" class="btn-primary btn-xs"  onclick="sdMenuCatalogos(2)"><i class="fa fa-refresh"></i></button>
        <?=$btnNuevo?>
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="javascript:void(0)" onclick="fn_catalogoAreas_lista(1)">  Solo activos</a></li>
                <li><a href="javascript:void(0)" onclick="fn_catalogoAreas_lista(2)">  Solo inactivos</a></li>
                <li><a href="javascript:void(0)" onclick="fn_catalogoAreas_lista(3)">  Todos</a></li>
                <li><a href="javascript:void(0)" onclick="fn_catalogoAreas_lista(4)">  Ultimos 10 Registrados</a></li>
                <li><a href="javascript:void(0)" onclick="fn_catalogoAreas_lista(5)">  Ultimos 10 Actualizados</a></li>
            </ul>
        </div>
