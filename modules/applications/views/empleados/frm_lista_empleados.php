    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form name="SearchEmpleado" action="#" onsubmit="fngn_buscar_empleado(2); return false;" method="post">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="modal-footer">
                <button name="search" id="btnSearch" class="btn btn-primary btn-sm" onclick="fngn_buscar_empleado(2)" ><i class="fa fa-search"></i> Buscar</button>
