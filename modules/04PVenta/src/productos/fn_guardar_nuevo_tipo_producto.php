...
$TipoAparato = $_POST['tipo_aparato'];
...
$idProducto = $connect->set_nuevo_tipo_producto(
  array(
...
if($connect->_confirm){
    ...
    $SQlServer->_sqlQuery = "EXECUTE BDSPAPARATOS.dbo.sp_RegistraNuevoTipoAparato '$NoCategoria','1','$Descripcion','$FechaAlta','$FechaAlta','$TipoAparato' ";
    $SQlServer->execute_query();

    echo "<script>AddOptionSelect('#id_tpoproducto','$idProducto','$Descripcion');$('#btnCloseModal').click();</script>";
