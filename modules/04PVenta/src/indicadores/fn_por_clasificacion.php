...
SELECT 
    a.Clasificacion,
    b.Texto1,
    COUNT(a.Clasificacion) AS TotalClasificacion
FROM
    BGEEncuestaProducto AS a 
JOIN BGECatalogoGeneral as b 
ON a.Clasificacion = b.Descripcion AND a.NoCategoria = b.Numero2  AND CodCatalogo = 7
WHERE
    a.NoAtendidos = 3 ".$where_final."
GROUP BY a.Clasificacion ORDER BY TotalClasificacion DESC
";
...
for($i=0;$i< count($Competencia);$i++){
    ...
    $data_competencia .= "['".$Competencia[$i][0]."',".$Competencia[$i][2]."],";
}
...
<div class="row">
    ...
    <div class="col-md-5">
        <div class="box box-primary">
            <div class="box-header"><i class="fa fa-dashboard"></i> Clientes no atendidos por clasificación de producto</div>
            <div class="box-body">
                <table class="table table-hove table-striped">
                    ...
                    for($i=0;$i <count($Competencia);$i++){
                        ...
                        echo "<tr><td>$contador</td><td>".$Competencia[$i][0]."</td><td>".$Competencia[$i][1]."</td><td><span class='badge'>".$connect->getFormatFolio($Competencia[$i][2],4)."</span></td></tr>";
