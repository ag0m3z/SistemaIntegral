    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    Tipo aparato:
                    <select class="formInput" id="tipo_aparato">
                        <option value="0">-- --</option>
                        <option value="1">Aparatos Chicos</option>
                        <option value="2">Aparatos Grandes</option>
                    </select>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn_nuevo_tipo_producto(2,1,0)" ><i class="fa fa-save"></i> Guardar</button>
