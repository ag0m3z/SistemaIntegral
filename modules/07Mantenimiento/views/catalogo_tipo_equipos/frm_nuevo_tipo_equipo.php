...
<script>
    ...
    setOpenModal("mdl_nuevo_tipo_equipo");

</script>

<div class="modal fade" id="mdl_nuevo_tipo_equipo" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-list"></i> Nuevo Tipo de Equipo</h4>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07NuevaTipoEquipo(2)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalNuevoTipoEquipo" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
