...
$connect->get_ubicacion($_POST['idubicacion']);

?>

<script>

    setOpenModal("mdl_editar_ubicacion");
...
<div class="modal fade" id="mdl_editar_ubicacion" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-home"></i> Editar Ubicación - <?=$connect->getNombreUbicacion()?></h4>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                Nombre:
                                                <input id="nombre" value="<?=$connect->getNombreUbicacion()?>" class="form-control input-sm" placeholder="Nombre Empresa "/>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07EditarUbicacion(2,<?=$_POST['idubicacion']?>)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalEditarUbicacion" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
