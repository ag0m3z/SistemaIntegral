...
<script>
    ...
    setOpenModal("mdl_nueva_marca");

</script>

<div class="modal fade" id="mdl_nueva_marca" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-home"></i> Nuevo Marca</h4>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                Nombre:
                                                <input id="nombre" class="form-control input-sm" placeholder="Nombre marca "/>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07NuevaMarca(2)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalNuevaMarca" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
