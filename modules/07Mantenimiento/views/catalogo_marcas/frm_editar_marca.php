...
include "../../controller/ControllerCatalogoMarcas.php";
...
$connect = new ControllerCatalogoMarcas($_SESSION['data_login']['BDDatos']);
...
$connect->get_marca($_POST['idmarca']);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07EditarMarca(2,<?=$_POST['idmarca']?>)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalEditarMarca" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
