...
<script>
    ...
    setOpenModal("mdl_nueva_refaccion");

</script>

<div class="modal fade" id="mdl_nueva_refaccion" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-wrench"></i> Nueva Refacción</h4>
            </div>
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                Nombre:
                                                <input id="nombre" class="form-control input-sm" placeholder="Nombre Refacción "/>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07NuevaRefaccion(2)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalNuevaRefaccion" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
