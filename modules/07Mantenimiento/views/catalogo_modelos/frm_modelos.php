...
<div class="panel panel-info">
    <div class="panel-heading">
        <i class="fa fa-list-alt"></i> Católogo Modelos
    </div>
    <div class="toolbars">

        <button class="btn animated fadeIn btn-xs btn-primary" onclick="fnsdMenu(34,34)"><i class="fa fa-refresh"></i></button>
            <button class="btn animated fadeIn btn-xs btn-primary" onclick="fn07NuevoModelo(1)"><i class="fa fa-file"></i> Nuevo</button>
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a href="#" onclick="fn07ListarModelo(3,0)">Todos</a></li>
                <li><a href="#" onclick="fn07ListarModelo(2,0)">Solo Desactivados</a></li>
                <li><a href="#" onclick="fn07ListarModelo(1,1)">Solo Activados</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="#" onclick="fn07ListarModelo(4,0)" >Registrados Actualmente</a></li>
                <li><a href="#" onclick="fn07ListarModelo(5,0)">Actualizados Actualmente</a></li>
            </ul>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-search"></i> Buscar Modelo</h4>
            </div>
            <div class="modal-body">
                <form action="#" method="post" onsubmit="fn07ListarModelo(6,0);$('#btnCloseModal').click(); return false;">
                    <div class="form-group">
                        Busqueda por: nombre, descripción
                        <input id="txtSearch" class="form-control input-sm" placeholder="Busqueda de Modelo">
                    </div>
                </form>
            </div>
            <div class="modal-footer">

                <button class="btn btn-primary btn-sm" onclick="fn07ListarModelo(6,0);$('#btnCloseModal').click()" ><i class="fa fa-search"></i> Buscar</button>
