...
$connect->get_modelo($_POST['idmodelo']);

?>

<script>

    setOpenModal("mdl_editar_marca");
...
<div class="modal fade" id="mdl_editar_marca" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-home"></i> Editar Marca - <?=$connect->getNombre()?></h4>
            </div>
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="idmarca" class="form-control input-sm">
                                                    <option value="<?=$connect->getIDMarca()?>"><?=$connect->getNombreMarca()?></option>
                                                    <?php

                                                    $idMarca = $connect->getIDMarca();

                                                    $connect->_query = "SELECT idValor,Nombre FROM 07MTOCatalogoGeneral WHERE idTabla = 4 AND idValor <> $idMarca AND idestatus= 1 ORDER BY Nombre ";
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                Nombre:
                                                <input id="nombre" value="<?=$connect->getNombre()?>" class="form-control input-sm" placeholder="Nombre de la Marca "/>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" onclick="fn07EditarModelo(2,<?=$_POST['idmodelo']?>)" id="btnGuardarNuevoProveedor"><i class="fa fa-save"></i> Guardar</button>
                <button class="btn btn-danger btn-sm" id="btnCloseModalEditarModelo" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        </div>
    </div>
