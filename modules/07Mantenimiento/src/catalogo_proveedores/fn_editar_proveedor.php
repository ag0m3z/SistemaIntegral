...
if(
    array_key_exists('idproveedor',$_POST) &&
    ...
    if($connect->_confirm){
        ...
        echo "<script>getMessageNotify('','Proveedor Editado correctamente','success',3000);fn07ListarProveedores(3,1);$('#btnCloseModalEditarProveedor').click();</script>";
