...
if(
    ...
    if($connect->_confirm){
        ...
        echo "<script>getMessageNotify('','Ubicación registrada correctamente','',3000);$('#btnCloseModalNuevaUbicacion').click();fn07ListarUbicaciones(4,1);</script>";
