...
$rowData = $connect->get_list_ubicaciones($_POST['idestatus'],$_POST['opc'],$_POST['textSearch']);

if(count($rowData) > 0){
    for($i = 0 ; $i < count($rowData);$i++){

        $idTabla = $rowData[$i][0];
        $idRefaccion = $rowData[$i][1];
        ...
        $dataView[] = array(
            "hidRefaccion"=>"<a href='#'><span class='text-primary' onclick='fn07EditarRefaccion(1,$idRefaccion)' >".$connect->getFormatFolio($idRefaccion,4)."</span></a>",
            "hNombre"=>$rowData[$i][2],
...
<script language="JavaScript">
    ...
    var columns = [
        {id:"hidRefaccion",name:"#",field:"hidRefaccion",width:100,cssClass: "text-center text-info  btn-link", formatter: formatter},
