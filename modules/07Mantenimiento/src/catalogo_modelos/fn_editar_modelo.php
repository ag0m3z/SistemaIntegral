...
if(
    array_key_exists('idmodelo',$_POST) &&
    ...
    if($connect->_confirm){
        ...
        echo "<script>getMessageNotify('','Modelo Editado correctamente','success',3000);fn07ListarModelo(5,1);$('#btnCloseModalEditarModelo').click();</script>";
