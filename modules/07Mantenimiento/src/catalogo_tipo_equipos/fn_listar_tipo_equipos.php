...
$rowData = $connect->get_list_tipo_equipo($_POST['idestatus'],$_POST['opc'],$_POST['textSearch']);
...
if(count($rowData) > 0){
    for($i = 0 ; $i < count($rowData);$i++){
        ...
        $dataView[] = array(
            "hidUbicacion"=>"<a href='#'><span class='text-primary' onclick='fn07EditarTipoEquipo(1,$idUbicacion)' >".$connect->getFormatFolio($idUbicacion,4)."</span></a>",
            "hNombre"=>$rowData[$i][2],
