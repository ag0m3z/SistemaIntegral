...
array_key_exists('nombre',$_POST)
    ...
    if($connect->_confirm){
        ...
        echo "<script>getMessageNotify('','Tipo de Equipo registrado correctamente','',3000);$('#btnCloseModalNuevoTipoEquipo').click();fn07ListarTipoEquipos(4,1);</script>";
