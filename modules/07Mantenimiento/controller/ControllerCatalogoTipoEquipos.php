...
class ControllerCatalogoTipoEquipos extends \core\seguridad
{
    ...
    public function get_list_tipo_equipo($idEstatus = 1,$opcion =1, $Filtros = array()){
        ...
        switch ($opcion){
            case 1:
                ...
                WHERE idestatus = 1 AND idTabla = 3 ORDER BY a.Nombre ASC
                ";
                break;
            case 2:
                //Estatus Inactivos
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idestatus = 0 AND idTabla = 3 ORDER BY a.Nombre ASC";
                break;
            case 3:
                //Todos los registros
                $this->_query = "
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 3 ORDER BY a.Nombre ASC
                ";
            ...
            case 4:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaAlta) = date(now()) AND idTabla = 3 ORDER BY a.FechaAlta DESC
                              ";
                break;
            case 5:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaUM) = date(now()) AND idTabla = 3 ORDER BY a.FechaUM DESC
                ";
                break;
            case 6:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 3 AND a.Nombre LIKE '%$Filtros%' OR a.Descripcion LIKE '%$Filtros%' ORDER BY a.FechaAlta DESC
                ";
                break;
    ...
    public function set_tipo_equipo($data_array = array()){
        ...
        if(
            ...
            if(count($this->_rows) > 0 ){
                ...
                $this->_confirm = false;
                $this->_message =  "El nombre del tipo de equipo ya existe";
            ...
            $this->_confirm = false;
            $this->_message =  "No se encontraron las llaves para el registro del tipo de equipo";
    ...
    public function edit_tipo_equipo($data_array = array()){

        //Validar que vengan los datos principales
        if(
            array_key_exists('idtipo_equipo',$data_array) &&
            array_key_exists('nombre',$data_array)

        ){
            //Validar que no exista ya el Nombre del Proveedor
            $this->_query = "SELECT Nombre FROM 07MTOCatalogoGeneral WHERE Nombre = '$data_array[nombre]' AND idTabla = 3 AND idValor <> '$data_array[idtipo_equipo]' ";
            $this->get_result_query();
    ...
    public function get_tipo_equipo($idUbicacion = ""){
        ...
        if($idUbicacion != ""){
            ...
            $this->_query = "SELECT 
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idValor = $idUbicacion AND idTabla = 3 ORDER BY a.Nombre ASC";
            ...
            \core\core::MyAlert("Error no se encotro la ubicación seleccionado","error");
            $this->_confirm = false;
            $this->_message = "Error no se encotro la ubicación seleccionado";
