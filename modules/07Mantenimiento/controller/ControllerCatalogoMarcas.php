...
class ControllerCatalogoMarcas extends \core\seguridad
{
    ...
    public function get_list_marcas($idEstatus = 1,$opcion =1, $Filtros = array()){
        ...
        switch ($opcion){
            case 1:
                ...
                WHERE idestatus = 1 AND idTabla = 4 ORDER BY a.Nombre ASC
                ";
                break;
            case 2:
                //Estatus Inactivos
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idestatus = 0 AND idTabla = 4 ORDER BY a.Nombre ASC";
                break;
            case 3:
                //Todos los registros
                $this->_query = "
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 4 ORDER BY a.Nombre ASC
                ";
            ...
            case 4:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaAlta) = date(now()) AND idTabla = 4 ORDER BY a.FechaAlta DESC
                              ";
                break;
            case 5:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaUM) = date(now()) AND idTabla = 4 ORDER BY a.FechaUM DESC
                ";
                break;
            case 6:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 4 AND a.Nombre LIKE '%$Filtros%' OR a.Descripcion LIKE '%$Filtros%' ORDER BY a.FechaAlta DESC
                ";
                break;
    ...
    public function set_marca($data_array = array()){
        ...
        if(
            ...
            if(count($this->_rows) > 0 ){
                ...
                $this->_confirm = false;
                $this->_message =  "El nombre de la marca ya existe";
    ...
    public function edit_marca($data_array = array()){
        ...
        if(
            ...
            $this->_query = "SELECT Nombre FROM 07MTOCatalogoGeneral WHERE Nombre = '$data_array[nombre]' AND idTabla = 4 AND idValor <> '$data_array[idmarca]' ";
            $this->get_result_query();
            ...
            $this->_confirm = false;
            $this->_message =  "No se encontraron las llaves para el registro del la nueva marca";
        }
    ...
    public function get_marca($idUbicacion = ""){
        ...
        if($idUbicacion != ""){
            ...
            $this->_query = "SELECT 
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idValor = $idUbicacion AND idTabla = 4 ORDER BY a.Nombre ASC";
            ...
            if(count($this->_rows) == 1){
                ...
                $this->_confirm = true ;
                $this->_message = "Se encontro la marca";

            }else{
                $this->_confirm = false ;
                $this->_message = "No se encontro la marca" ;
            }


        }else{

            \core\core::MyAlert("Error no se encotro la marca seleccionado","error");
            $this->_confirm = false;
            $this->_message = "Error no se encotro la marca seleccionado";
