...
class ControllerCatalogoUbicaciones extends \core\seguridad
{
    ...
    public function get_list_ubicaciones($idEstatus = 1,$opcion =1, $Filtros = array()){
        ...
        switch ($opcion){
            case 1:
                ...
                WHERE idestatus = 1 AND idTabla = 2 ORDER BY a.Nombre ASC
                ";
                break;
            case 2:
                //Estatus Inactivos
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idestatus = 0 AND idTabla = 2 ORDER BY a.Nombre ASC";
                break;
            case 3:
                //Todos los registros
                $this->_query = "
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 2 ORDER BY a.Nombre ASC
                ";
            ...
            case 4:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaAlta) = date(now()) AND idTabla = 2 ORDER BY a.FechaAlta DESC
                              ";
                break;
            case 5:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE date(a.FechaUM) = date(now()) AND idTabla = 2 ORDER BY a.FechaUM DESC
                ";
                break;
            case 6:
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idTabla = 2 AND a.Nombre LIKE '%$Filtros%' OR a.Descripcion LIKE '%$Filtros%' ORDER BY a.FechaAlta DESC
                ";
                break;
    ...
    public function set_ubicaciones($data_array = array()){
        ...
        if(
            ...
            $this->_confirm = false;
            $this->_message =  "No se encontraron las llaves para el registro de la nueva ubicación";
    ...
    public function get_ubicacion($idUbicacion = ""){
        ...
        if($idUbicacion != ""){
            ...
            $this->_query = "SELECT 
                ...
                LEFT JOIN SINTEGRALGNL.BGECatalogoUsuarios as c 
                ON a.NoUsuarioUM = c.NoUsuario 
                WHERE idValor = $idUbicacion AND idTabla = 2 ORDER BY a.Nombre ASC";
