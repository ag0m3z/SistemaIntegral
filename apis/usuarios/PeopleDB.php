...
class PeopleDB
{
    ...
    public function getPeople($id=0){
        $stmt = $this->mysqli->prepare("SELECT * FROM BGECatalogoUsuarios WHERE NoUsuario=? ; ");
    ...
    public function getPeoples(){
        $result = $this->mysqli->query("SELECT * FROM BGECatalogoUsuarios LIMIT 0,10");
        $peoples = $result->fetch_all(MYSQLI_ASSOC);
        $result->close();
        return $peoples;
    }
